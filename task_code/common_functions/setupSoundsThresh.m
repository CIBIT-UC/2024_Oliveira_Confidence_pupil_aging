function sound = setupSoundsThresh(setup, audio)
%% auditory feedback
setup.feedbackcounterbalance = repmat([1 1 2 2], 1,250);
...
[sound.tonebuf, sound.tonepos] = CreateAudioBuffer(CreateTone(sound.stimonset, 0.050, audio.freq), ...
    ...
    CreateTone(sound.feedback.incorrect, 0.5, audio.freq)); % MISSED
