function [sound] = setupSounds(audio, ~)
%% auditory feedback
...
% else
%     wavfilename = [ pwd '/Ta Da.mp3']; % windows
% end
% 
...
[sound.tonebuf, sound.tonepos] = CreateAudioBuffer(CreateTone(sound.normal, sound.dur, audio.freq), CreateTone(sound.normal, sound.dur, audio.freq)); %, sound.wavedata
