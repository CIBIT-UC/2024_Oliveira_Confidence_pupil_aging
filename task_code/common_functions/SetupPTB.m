function [window1] = SetupPTB(window1, setup)
%Screen('Preference', 'SkipSyncTests', 1); %acrescentei!!!
...
[window1.width_px, window1.height_px] = Screen('WindowSize', window1.screenNum); %MariaRibeiro
...
% audio.h = PsychPortAudio('Open', [], [], 0, audio.freq, 2); %pahandle
