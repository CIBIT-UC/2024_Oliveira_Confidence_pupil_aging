...
for participant = 1:20
    filename1 = ['Participant',num2str(participant),'_111.set'];
    filename2 = ['Participant',num2str(participant),'_112.set'];
    filename3 = ['Participant',num2str(participant),'_113.set'];
    filename4 = ['Participant',num2str(participant),'_114.set'];
